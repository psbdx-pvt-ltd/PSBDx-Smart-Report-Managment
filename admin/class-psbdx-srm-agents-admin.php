...
class PSBDX_SRM_Agents_Admin {
	...
	public function handle_actions() {
		...
		if ( isset( $_POST['psbdx_srm_agent_add'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Missing -- this only routes to the right handler; each handle_*() method verifies its own nonce via check_admin_referer() before touching any POST data.
			$this->handle_add();
