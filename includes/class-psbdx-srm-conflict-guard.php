...
class PSBDX_SRM_Conflict_Guard {
	...
	public function run_security_scan() {
		...
		// 3. Check if a captcha provider is configured when any form has captcha enabled.
		...
		// 4. AI features are turned on, but this site no longer meets the
		...
		// 5. The AI Response Log table is marked as installed but is
		...
		// 6. AI is enabled and recent requests are consistently failing —
