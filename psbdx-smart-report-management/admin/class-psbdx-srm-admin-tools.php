				...
				<table class="widefat psbdx-srm-status-table">
					...
					<tbody>
						...
						<tr class="psbdx-srm-new-row">
							...
							<td><label><input type="checkbox" name="psbdx_srm_status_remove[]" value=""> <?php esc_html_e( 'Remove', 'psbdx-smart-report-management' ); ?></label></td>
						</tr>
					</tbody>
				</table>
				<p>
		...
		<script>
			(function () {
				...
				addBtn.addEventListener('click', function () {
					...
					row.className = 'psbdx-srm-new-row';
					row.innerHTML =
						'<td>' +
							'<input type="hidden" name="psbdx_srm_status_key[]" value="">' +
							'<input type="text" class="regular-text" name="psbdx_srm_status_label[]" value="" placeholder="<?php echo esc_js( __( 'New status label', 'psbdx-smart-report-management' ) ); ?>">' +
						'</td>' +
						'<td><input type="text" class="psbdx-srm-color" name="psbdx_srm_status_bg[]" value="#e2e8f0" pattern="^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$"></td>' +
						'<td><input type="text" class="psbdx-srm-color" name="psbdx_srm_status_color[]" value="#475569" pattern="^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$"></td>' +
						'<td><label><input type="checkbox" name="psbdx_srm_status_remove[]" value=""> <?php echo esc_js( __( 'Remove', 'psbdx-smart-report-management' ) ); ?></label></td>';
