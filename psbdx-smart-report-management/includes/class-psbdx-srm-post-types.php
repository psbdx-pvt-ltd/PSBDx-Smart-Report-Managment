...
class PSBDX_SRM_Post_Types {
	...
	private function register_report_log() {
		$labels = array(
			'name'               => _x( 'Report Logs', 'post type general name', 'psbdx-smart-report-management' ),
			'singular_name'      => _x( 'Report Log',  'post type singular name', 'psbdx-smart-report-management' ),
			'edit_item'          => __( 'View Report Log',     'psbdx-smart-report-management' ),
			'search_items'       => __( 'Search Report Logs',  'psbdx-smart-report-management' ),
			'not_found'          => __( 'No reports found.',          'psbdx-smart-report-management' ),
			'not_found_in_trash' => __( 'No reports found in Trash.', 'psbdx-smart-report-management' ),
			'menu_name'          => __( 'Report Logs', 'psbdx-smart-report-management' ),
		);
